<template>
  <div>
    ...
    <div class="p-4 md:ml-64">
      ...
      >
        <v-btn
          @click="fn_submit('draft')"
          flat
          class="!bg-[#084F93] text-white flex gap-[15px] items-center justify-center !rounded-[8px] !h-[56px] lg:w-[358px] w-full mb-[15px]"
        >
  ...
  <v-dialog v-model="dialogConfirm" width="354px">
    <div class="bg-white !rounded-[8px] !p-[15px] text-center">
      ...
      <p class="font-bold text-[16px]">{{ dialogStatus === 'draft' ? 'บันทึกฉบับร่าง' : 'สำเร็จ'}}</p>
      <pre class="text-[#000]/[0.6] text-center">{{ dialogStatus === 'draft' ? 'บันทึกฉบับร่าง คอนเทนต์สำเร็จ\nโปรดตรวจรายการคอนเทต์เพื่อดูรายละเอียด' : 'สร้างคอนเทนต์สำเร็จ\nโปรดตรวจรายการสินค้าเพื่อดูรายละเอียด'}}</pre>
    </div>
  </v-dialog>
</template>
