<template>
  <Toolbars />
  <Navbar text="การเงิน,ค่าขนส่ง,ชุดข้อมูลราคาขาย,560416510620" />
  ...
  <div class="p-4 md:ml-64 flex flex-col">
    ...
    <b class="text-[18px] mt-[12px] mb-[12px]">ข้อมูลราคา</b>
    <div
    ...
    <b class="text-[18px]">ราคาโปรโมชั่น</b>

    <v-data-table
      v-if="itemsPromotion.length > 0"
      :custom-filter="filterOnlyCapsText"
      :headers="headersPromtion"
    ...
    <div>
      <NuxtLink
        to="/billing/sell/create/promotion"
        flat
        class="flex text-white justify-center gap-[8px] rounded-[8px] items-center lg:basis-2/12 !h-[56px]"
      >
        <v-icon icon="mdi-plus" color="#0BA5EC"></v-icon>
        <div class="text-[#0BA5EC]">เพิ่มรายการโปรโมชั่น</div>
      </NuxtLink>
    </div>
    <div
      class="lg:flex block gap-[15px] lg:justify-center justify-between mt-[12px]"
